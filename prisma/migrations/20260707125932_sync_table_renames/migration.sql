-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'ON_GOING', 'COMPLETED', 'CANCELLED');
...
-- CreateIndex
CREATE UNIQUE INDEX "rental_orders_transactionId_key" ON "rental_orders"("transactionId");
...
-- AddForeignKey
ALTER TABLE "rental_orders" ADD CONSTRAINT "rental_orders_gearItemId_fkey" FOREIGN KEY ("gearItemId") REFERENCES "gear_items"("id") ON DELETE CASCADE ON UPDATE CASCADE;
